...
function onOpen() {
  ...
  ui.createMenu('Twitter Tools')
    .addItem('Update Nov 2025 (Process 20)', 'updateTwitterViewCounts')
    .addItem('Continue Nov Processing', 'continueProcessing')
    .addSeparator()
