...
```javascript
const CONFIG = {
  SHEET_NAME: 'Nov 2025',        // Change to YOUR sheet name (e.g., 'Data', 'Tweets', etc.)
...
**Note:** The current default values (`Nov 2025`, column `D`, column `E`) are just examples - adapt them to your spreadsheet!
