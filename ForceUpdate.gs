...
/**
 * Clear all force update progress for August 2025
 * Use this to start completely fresh
 */
function clearAugustForceProgress() {
  ...
  scriptProperties.deleteProperty('LAST_PROCESSED_ROW');
  console.log('August 2025 force update progress cleared.');
  SpreadsheetApp.getUi().alert('August 2025: Force update progress cleared. Next run will start from the beginning.');
}
